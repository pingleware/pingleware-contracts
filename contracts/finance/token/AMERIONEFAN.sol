...
contract AmeriOneCorporationNonProfitMembershipToken is Version, Frozen, IERC20TOKEN {
    string public constant DESCRIPTION = 
        string("A membership token for use with the non-profit organization Amerione Corporation. NOT TAX DEDUCTIBLE.");
    string public name;
