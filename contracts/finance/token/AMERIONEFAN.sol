...
contract AmeriOneCorporationNonProfitMembershipToken is IERC20TOKEN {
    string public constant DESCRIPTION = string("A membership token for use with the non-profit organization Amerione Corporation. NOT TAX DEDUCTIBLE.");
    string public name;
    ...
    constructor() payable {
        name = "AmeriOne Corporation Non-Profit Membership Token";
        symbol = "AMERIONE.FAN";
        decimals = 0;
        owner = msg.sender;
