...
/**
 * aka Asset-backed security (ABS)
 */

contract PRESSPAGEENTERTAINMENTINCABS506B is IERC20TOKEN {
    string public constant DESCRIPTION = string("Private Debt Token for PressPage Entertainment Inc (SEC File #021-332144) under Rule 506b at https://www.sec.gov/Archives/edgar/data/0001766947/000176694719000001/xslFormDX01/primary_doc.xml. FOR ACCREDITED INVESTORS ONLY.");
    string public name;
    ...
    constructor() payable {
        name = "PRESSPAGE ENTERTAINMENT INC PRIVATE DEBT (ABS) 506B";
        symbol = "PRESSPAGE506BABS";
        decimals = 0;
        owner = msg.sender;
