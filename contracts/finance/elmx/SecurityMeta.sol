...
/**
 * DUE TO SIZE LIMITATIONS ON CONTRACT BYTECODE, SecurityMeta WAS CREATED TO MAINTAIN AN ACTIVE
 * RECORD OF SEUCIRTY TOKENS CUSIP, ISIN, CERTIFICATE ASSIGNED NUMBERS AS WELL AS OTHER SECUIRTY METADATA
 */
