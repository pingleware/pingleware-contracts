...
interface IBestBooks {
    ...
    event EntryAdded(uint256 index,uint256 timestamp,string debitAccount,string creditAccount,string description,int256 debitAmount,int256 creditAmount);
    event EntryDeleted(uint256 timestamp,string debitAccount,string creditAccount,string description,int256 debitAmount,int256 creditAmount,string reason);
